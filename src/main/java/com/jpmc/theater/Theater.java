...
public class Theater {
    ...
    public void printSchedule() {
        ...
        System.out.println("===================================================");
        schedule.forEach(s -> System.out.println(new Gson().toJson(s)));
        System.out.println("===================================================");
    ...
    public void printScheduleInJson() {
        ...
        schedule.forEach(s ->
            ...
            System.out.println("\"runningTime\": " + humanReadableFormat(s.getMovie().getRunningTime())+ ",");
            System.out.println("\"showPrice\": \"$" + s.getMovieFee() + "\"");
            System.out.println("},");
